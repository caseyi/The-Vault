          ...
          {queue.map((item, index) => (
            ...
            >
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                <span style={{ width: 7, height: 7, borderRadius: '50%', background: STATUS_COLORS[item.print_status] || '#4a4a5a', flexShrink: 0 }} />
                <span style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: 'var(--text-faint)' }}>{item.print_status}</span>
              </div>
